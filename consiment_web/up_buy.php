...
echo $tid;
	if(isset($_POST['submit'])){
			$query = "UPDATE CON_TRANSACTION SET STATUS = 'Proof Sent', BUY_PROOF = '$key' WHERE T_ID = '$tid'";
			//UPDATE CON_TRANSACTION SET STATUS = 'BTransfered', BUY_PROOF = 'jjjj' WHERE T_ID = '10024';
...
<body>
    ...
    <form action='up_buy.php?T_ID=<?php echo $tid; ?>' enctype="multipart/form-data" method='post'>
