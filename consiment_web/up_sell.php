...
<?PHP
	if(isset($_POST['submit'])){ 
			$query = "UPDATE CON_TRANSACTION SET STATUS = 'Sent',SEND_PROOF = '$key' WHERE T_ID = '$tid'";
...
<form action='up_sell.php?T_ID=<?php echo $tid; ?>'enctype="multipart/form-data" method='post'>
